...
const Intro = () => (
  <section className="section grid">
    ...
    <p className="t-body grid__item section__copy" data-grid-medium="6">Need an easy calculator for your Twitch/YouTube stream? I got ya <span role="img" aria-label="smile">😁</span>!! The results of <a href="#resultLow" className="t-link">Low</a> under recommended bitrate are based off industry standards for streaming low movement content like Teamfight Tactics. While the <a href="#resultHigh" className="t-link">High</a> value will serve you well if you’re playing a game with lots of movement like Modern Warfare and more first person shooters.</p>
